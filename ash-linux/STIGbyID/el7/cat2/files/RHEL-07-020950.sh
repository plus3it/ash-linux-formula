...
#
# STIG URL:
# Finding ID:	RHEL-07-020950
# Version:	RHEL-07-020950_rule
# SRG ID:	
# Finding Level:	medium
#
# Rule Summary:
#     Device files and directories must only be writable by users with 
#     a system account or as configured by the vendor.
#
