#!/bin/sh
# Finding ID:	RHEL-07-030490
# Version:	RHEL-07-030490_rule
...
diag_out "   audit records for all"
diag_out "   successful/unsuccessful account"
diag_out "   access count events."
diag_out "----------------------------------------"
